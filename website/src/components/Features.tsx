...
const features: Feature[] = [
  ...
  },
  {
    ...
    description:
      "Build pages, fix bugs, optimize SEO, and deploy updates — manage your online presence straight from WhatsApp.",
    userMessage: "Add a testimonials section to my landing page",
    botReply: "Section added and deployed to yoursite.com. Want to review it?",
  },
  {
    Icon: InvoicingIcon,
