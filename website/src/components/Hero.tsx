  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden px-6 pt-20">
      ...
      <div className="relative z-10 mx-auto max-w-3xl text-center">
        <h1 className="text-5xl font-extrabold leading-tight tracking-tight text-heading sm:text-6xl lg:text-7xl">
          Let me help you
          <br />
        ...
        <p className="mx-auto mt-6 max-w-xl text-lg text-body sm:text-xl">
